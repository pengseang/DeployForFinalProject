...
export function Login() {
  ...
  const [AccessToken, setAccessToken] = useState(""); // Starting with an empty string
  useEffect(() => {
    if (AccessToken) {
      console.log("accessToken updated:", AccessToken);
    } else {
      console.log("accessToken is not set yet");
    }
  }, [AccessToken]);
  ...
  const handleLogin = async (values) => {
    try {
      ...
      if (!data?.status) {
        toast.error(data.error.description[0].reason);
      } else {
    ...
    <section>
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          // console.log("helloValure",values)
                ...
                <div className="text-center mb-14">
                  <div className="flex justify-between mb-8">
                    ...
                    <Link to="/" className="flex">
                      <img
                        src="http://dealkh-api.istad.co:80/images/a616d2b8-a0b9-49f5-83e4-447520943679.png"
                        alt="logo"
