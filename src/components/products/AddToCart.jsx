...
export function AddToCart() {
  ...
  return (
    ...
    <main className="flex flex-col max-w-6xl p-6 mx-auto md:flex-row ">
      {/* Shopping cart table */}
      <div className="p-5 mx-6 border rounded-lg p-26 fa-border md:w-2/3 ">
        <h2 className="mb-4 text-xl font-bold dark:text-white">Shopping Cart</h2>
              ...
              <tr className="border-b">
                <td className="flex items-center px-8 py-4 space-x-4">
                  ...
                  <img
                    alt="Smart-TV"
                    className="w-12 h-12"
                    src="http://dealkh-api.istad.co:80/images/339730a7-2849-4abf-b648-645940dbc807.png"
                    width="50"
                    height="50"
                  />
              ...
              <tr className="border-b">
                <td className="flex items-center px-8 py-4 space-x-4">
                  ...
                  <img
                    ...
                    className="w-12 h-12"
                    src="http://dealkh-api.istad.co:80/images/9c51d024-33a1-45a0-9c90-c38c5e7199e8.png"
                    width="50"
                    height="50"
                  />
                  <span className="text-xs font-bold">
      ...
      {/* Cart totals */}
      <div className="p-6 mt-6 border rounded-lg md:mt-0 md:w-1/3 dark:text-white">
