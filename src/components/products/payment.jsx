  ...
  return (
    <main class=" bg-gray-100 flex items-center justify-center p-4 sm:p-8 min-w-80">
      <div class="bg-white rounded-lg shadow-lg flex flex-col sm:flex-row max-w-2xl w-full mx-auto">
        ...
        <div class="bg-gradient-to-r from-teal-400 to-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 text-white p-6 sm:p-8 flex flex-col items-center sm:w-1/3 ">
        ...
        <div class="p-6 sm:p-8 sm:w-2/3">
          ...
          <section class="border rounded-lg">
            <div class="flex justify-center mb-4">
              <img
                ...
                src="http://dealkh-api.istad.co:80/images/5008a8c7-917d-4732-9e5a-5c3770b78d7c.jpg"
              />
            </div>
          ...
          <div class="flex justify-center items-center">
            <img
              ...
              src="http://dealkh-api.istad.co:80/images/6baa96cc-26ce-4247-a7ab-5a744060d0d4.png"
              alt="aba-bank"
            />
          </div>
        </div>
